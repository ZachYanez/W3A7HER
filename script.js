var citySearch; // only used for search bar
...
function getWeather(citySearch) {
 ...
 function get5Day(cityName){
    ...
    .then(function(response){
        console.log("5 Day Forecast " + cityName + ":" , response);
...
// Gets UV Index and Populates
    function getUVindex(cityObject){
        var apiKey = "8508d545d4e36b4c3c13e5d8071e830e";
        var queryURL = `https://api.openweathermap.org/data/2.5/uvi/forecast?appid=${apiKey}&lat=${cityObject.lat}&lon=${cityObject.lon}&cnt=6`;
...
//  Displays 5 Day
    function current5DayDisplay(forecastData){
        var iconurl1 = "https://openweathermap.org/img/wn/" + forecastData.icon1 + "@2x.png"
        var iconurl2 = "https://openweathermap.org/img/wn/" + forecastData.icon2 + "@2x.png"
        var iconurl3 = "https://openweathermap.org/img/wn/" + forecastData.icon3 + "@2x.png"
        var iconurl4 = "https://openweathermap.org/img/wn/" + forecastData.icon4 + "@2x.png"
        var iconurl5 = "https://openweathermap.org/img/wn/" + forecastData.icon5 + "@2x.png"
 ...
 // Displaying current Weather
    function currentWeatherDisplay(currentCity) {
        var iconurl = "https://openweathermap.org/img/wn/" + currentCity.icon + "@2x.png"
